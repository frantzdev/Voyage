<template>
  ...
  <section class="photo">    
      ...
      <p class="firstLine">Le tourisme dans l'univers</p>
      <p class="secondLine">est maintenant ...</p>
      <p class="thirdLine">Accessible à tous !</p>
    <router-link to="/destination">
      <a type="button" role="button" class="buttonHome" title="Cliquez ici pour consulter toutes nos destinations">
        <p>Cliquez pour voyager !</p>
      </a>
    </router-link>
    <button class="btn-nav left" @click="prevSlide"><i class="fas fa-chevron-left"></i></button>
    <button class="btn-nav right" @click="nextSlide"><i class="fas fa-chevron-right"></i></button>
  </section>
